---------------------------------------------------------------------
-- Integration test: ask the real Ornith-9B to call a tool.
--
-- Loads the real dense Qwen3.5 (DeepReinforce Ornith-1.0 9B Q4_K_M)
...
-- ORNITH_9B pointing at the file (skips cleanly if unset/missing).
...
begin
   Put_Line ("=== test_chat_tools_integration (ornith + tools) ===");
