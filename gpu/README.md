...
- **Kernels** (`phase1/`): Q4_K + Q6_K dequant & matvec (bit-exact vs CPU),
  RMSNorm / RoPE / SiLU / GQA-attention (≤1e-6), full transformer layer (2.3e-7),
  throughput ~2.25 tok/s un-tiled (~180× CPU at 70B scale). See `phase1/README.md`.
